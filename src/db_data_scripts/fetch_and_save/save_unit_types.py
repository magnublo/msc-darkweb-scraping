...
for l in listings:
    if l.unit_type not in unit_types:
        listing_titles_and_unit_types.append((l.title, l.unit_type))
    unit_types.add(l.unit_type)

with open(f"{ROOT_SRC_DIR}/db_data_scripts/pickle_data/cryptonia_titles_and_unit_types.pickle", "wb") as f:
    pickle.dump(listing_titles_and_unit_types, f)
